...
try:
    ...
    Himage = Image.new('1', (epd.height, epd.width), 255)  # 255: clear the frame
    draw = ImageDraw.Draw(Himage)
    draw.text((10, 0), 'date_string', font = font24, fill = 0)
    draw.text((10, 20), 'week_string', font = font24, fill = 0)
    ...
    while (True):
        ...
        newimage = time_image.crop([10, 10, 120, 50])#剪下
        time_image.paste(newimage, (10,10))#貼上
